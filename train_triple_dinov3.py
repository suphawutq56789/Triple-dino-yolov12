...
def main():
    ...
    parser.add_argument('--weight-decay', type=float, default=0.002,
                       help='Weight decay for regularization (default 0.002)')
    ...
    parser.add_argument('--iou', type=float, default=0.45,
                       help='IoU threshold for NMS (default 0.45, lower = better for thin objects)')
    ...
    parser.add_argument('--mosaic', type=float, default=0.4,
                       help='Mosaic augmentation probability (default 0.4)')
    parser.add_argument('--degrees', type=float, default=4.0,
                       help='Rotation augmentation degrees (default 4.0)')
    ...
    parser.add_argument('--scale', type=float, default=0.30,
                       help='Scale augmentation gain (default 0.30)')
    parser.add_argument('--shear', type=float, default=0.0,
                       help='Shear augmentation degrees (default 0.0)')
    parser.add_argument('--flipud', type=float, default=0.05,
                       help='Vertical flip probability (default 0.05)')
